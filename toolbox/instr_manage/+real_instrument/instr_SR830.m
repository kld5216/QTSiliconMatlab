classdef instr_SR830<instrument.PSR830
    ...
    methods
        function obj = instr_SR830(name,address,filepath)
                ...
                switch varargin{1}
                    ...
                    case 'step'
                        if isempty(varargin{2})
                            error('instr_SR830:set_slow','lack of index');
                        elseif ~isfloat(varargin{2})||varargin{2} <= 0
                            error('instr_SR830:set_slow','step应为大于0的浮点数');
                        end
                    ...
                    case 'delay'
                        if isempty(varargin{2})
                            error('instr_SR830:set_slow','lack of index');
                        elseif ~isfloat(varargin{2})||varargin{2} <= 0
                            error('instr_SR830:set_slow','delay应为大于0的浮点数');
                        end
